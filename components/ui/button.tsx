  ...
  'inline-flex items-center justify-center rounded-sm text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50',
  {
    variants: {
      variant: {
        ...
        custom:
          'bg-palette text-primary-foreground hover:bg-palette/90 dark:font-semibold',
        destructive:
          'bg-destructive text-destructive-foreground hover:bg-destructive/90',
        outline:
          'border border-input bg-background dark:bg-accent hover:bg-accent dark:hover:bg-palette hover:text-accent-foreground dark:hover:text-primary-foreground dark:hover:font-semibold',
        secondary:
